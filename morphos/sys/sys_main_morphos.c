...
#include "../dll.h"
#undef  Sys_UnloadLibrary
#undef  Sys_LoadLibrary
#undef  Sys_LoadFunction
#define Sys_UnloadLibrary dllFreeLibrary
#define Sys_LoadLibrary(name) dllLoadLibrary( (char *)name, 0 )
#define Sys_LoadFunction dllGetProcAddress
